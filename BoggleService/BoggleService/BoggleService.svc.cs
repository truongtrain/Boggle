...
namespace Boggle
{
    public class BoggleService : IBoggleService
    {
        ...
        public void CancelJoinRequest(UserInfo user)
        {
            lock (sync)
            {
        ...
        public GameInfo JoinGame(UserInfo user)
        {
        ...
        public WordPlayed PlayWord(UserInfo user, string GameID)
        {
